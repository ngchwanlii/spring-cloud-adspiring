package com.adspiring.ad.mysql.constant;
...
public class Constant {
    ...
    private static final String DB_NAME = "adspiring_ad_data";

    public static final class AD_PLAN_TABLE_INFO {
    ...
    public static class AD_CREATIVE_TABLE_INFO {
        ...
        public static final String COLUMN_WIDTH = "weight";
    ...
    public static class AD_UNIT_INTEREST_TABLE_INFO {
        ...
        public static final String COLUMN_UNIT_ID = "unit_id";
        public static final String COLUMN_INTEREST_TAG = "tag";
